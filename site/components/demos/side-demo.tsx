...
const { StacksheetProvider: RightProvider, useSheet: useRightSheet } =
	createStacksheet({ side: "right" });

const { StacksheetProvider: LeftProvider, useSheet: useLeftSheet } =
	createStacksheet({ side: "left" });

const { StacksheetProvider: BottomProvider, useSheet: useBottomSheet } =
	...
	return (
		<div className="sheet-content">
			...
			<p>
				...
				object like <code>{`{ desktop: "right", mobile: "bottom" }`}</code>.
			</p>
		</div>
	);
}
