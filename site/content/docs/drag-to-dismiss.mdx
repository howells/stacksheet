...
For bottom panels, drag is suppressed when the scroll container has been scrolled down (`scrollTop > 0`). This prevents conflicts between scrolling content back to the top and dismissing the sheet. Once scrolled to the top, drag works normally.
