...
| `"bouncy"` | 260 | 12 | 1 | Visible bounce, energetic |
...
|---|---|---|
| **primary** | Top sheet entrance/exit | Your config directly |
| **stack** | Behind-sheets contracting | 60% stiffness, 140% mass |
| **exit** | Pop/close animation | 50% stiffness, 120% mass |
