...
| `onCloseComplete` | `(reason: CloseReason) => void` | — | Called when last panel exit animation completes. See [Callbacks](/docs/callbacks). |
...
Bottom sheets can snap to predefined heights instead of only fully open or fully closed. See [Snap Points](/docs/snap-points) for the full API and examples.
